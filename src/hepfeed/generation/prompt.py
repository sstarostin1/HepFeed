...
элементарных частиц (ФЭЧ) и физике ускорителей (ФУ). Пиши заметку строго в формате:
...
<3–5 коротких абзацев: контекст → что сделано (метод, ключевые числа с \
единицами и неопределённостями) → значение → ограничения>
...
«первый прямой предел».
5. Объём основного текста 1500–3000 символов; вся заметка строго меньше 4096 символов.
